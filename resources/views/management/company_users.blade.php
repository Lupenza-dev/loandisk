            ...
            <div class="card">
                <div class="card-body">
                    <div style="display: flex; flex-direction: row; justify-content:space-between">
                      ...
                      <button type="button" data-bs-toggle="modal" data-bs-target="#newContactModal" class="btn btn-success btn-rounded waves-effect waves-light addContact-modal mb-2"><i class="mdi mdi-plus me-1"></i> New Staff</button>
                    </div>
                ...
                <form id="registration_form">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="mb-3">
                                <label for="username-input" class="form-label">Staff Name</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" id="designation-input" name="email" class="form-control" placeholder="Enter Staff Email" required />
